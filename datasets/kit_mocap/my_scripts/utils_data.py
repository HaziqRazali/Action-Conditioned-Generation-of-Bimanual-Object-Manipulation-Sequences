...
# model file
outputModelFile = {"1723":"~/MMMTools/data/Model/Winter/mmm.xml",
                   "1480":"~/MMMTools/data/Model/Winter/mmm.xml",
                   "egg_whisk":"~/MMMTools/data/Model/Objects/egg_whisk/egg_whisk.xml",
                   "apple_juice":"~/MMMTools/data/Model/Objects/apple_juice/apple_juice.xml",
                   "apple_juice_lid":"~/MMMTools/data/Model/Objects/apple_juice_lid/apple_juice_lid.xml",
                   "milk_small":"~/MMMTools/data/Model/Objects/milk_small/milk_small.xml",
                   "milk_small_lid":"~/MMMTools/data/Model/Objects/milk_small_lid/milk_small_lid.xml",
                   "ladle":"~/MMMTools/data/Model/Objects/ladle/ladle.xml",
                   "mixing_bowl_small":"~/MMMTools/data/Model/Objects/mixing_bowl_small/mixing_bowl_small.xml",
                   "mixing_bowl_green":"~/MMMTools/data/Model/Objects/mixing_bowl_green/mixing_bowl_green.xml",
                   "salad_fork":"~/MMMTools/data/Model/Objects/salad_fork/salad_fork.xml",
                   "rolling_pin":"~/MMMTools/data/Model/Objects/rolling_pin/rolling_pin.xml",
                   "kitchen_sideboard":"~/MMMTools/data/Model/Objects/kitchen_sideboard/kitchen_sideboard.xml",
                   "draining_rack":"~/MMMTools/data/Model/Objects/draining_rack/draining_rack.xml",
                   "plate_dish":"~/MMMTools/data/Model/Objects/plate_dish/plate_dish.xml",
                   "sponge_small":"~/MMMTools/data/Model/Objects/sponge_small/sponge_small.xml",
                   "salad_spoon":"~/MMMTools/data/Model/Objects/salad_spoon/salad_spoon.xml",
                   "cucumber_attachment":"~/MMMTools/data/Model/Objects/cucumber_attachment/cucumber_cut.xml",
                   "cutting_board_small":"~/MMMTools/data/Model/Objects/cutting_board_small/cutting_board_small.xml",
                   "knife_black":"~/MMMTools/data/Model/Objects/knife_black/knife_black.xml",
                   "peeler":"~/MMMTools/data/Model/Objects/peeler/peeler.xml",
                   "cup_large":"~/MMMTools/data/Model/Objects/cup_large/cup_large.xml",
                   "cup_small":"~/MMMTools/data/Model/Objects/cup_small/cup_small.xml",
                   "tablespoon":"~/MMMTools/data/Model/Objects/tablespoon/tablespoon.xml"}
for k,v in outputModelFile.items():
    outputModelFile[k] = os.path.expanduser(v)
    #print(outputModelFile[k])

# physical markers defined in motion.xml -> physical markers defind in mmm.xml, mixing_bowl_green.xml, ...
converterConfigFile = {"1723":"~/MMMTools/data/Model/Winter/NloptConverterVicon2MMM_WinterConfig.xml",
                       "1480":"~/MMMTools/data/Model/Winter/NloptConverterVicon2MMM_WinterConfig.xml",
                       "egg_whisk":"~/MMMTools/data/Model/Objects/egg_whisk/NloptConverterVicon2MMM_EggWhiskConfig.xml",
                       "apple_juice":"~/MMMTools/data/Model/Objects/apple_juice/NloptConverterVicon2MMM_AppleJuiceConfig.xml",
                       "apple_juice_lid":"~/MMMTools/data/Model/Objects/apple_juice_lid/NloptConverterVicon2MMM_AppleJuiceLidConfig.xml",
                       "milk_small":"~/MMMTools/data/Model/Objects/milk_small/NloptConverterVicon2MMM_MilkSmallConfig.xml",
                       "milk_small_lid":"~/MMMTools/data/Model/Objects/milk_small_lid/NloptConverterVicon2MMM_MilkSmallLidConfig.xml",
                       "ladle":"~/MMMTools/data/Model/Objects/ladle/NloptConverterVicon2MMM_LadleConfig.xml",
                       "mixing_bowl_small":"~/MMMTools/data/Model/Objects/mixing_bowl_small/NloptConverterVicon2MMM_MixingBowlSmallConfig.xml",
                       "mixing_bowl_green":"~/MMMTools/data/Model/Objects/mixing_bowl_green/NloptConverterVicon2MMM_MixingBowlGreenConfig.xml",
                       "salad_fork":"~/MMMTools/data/Model/Objects/salad_fork/NloptConverterVicon2MMM_SaladForkConfig.xml",
                       "rolling_pin":"~/MMMTools/data/Model/Objects/rolling_pin/NloptConverterVicon2MMM_RollingPinConfig.xml",
                       "kitchen_sideboard":"~/MMMTools/data/Model/Objects/kitchen_sideboard/NloptConverterVicon2MMM_KitchenSideboardConfig.xml",
                       "draining_rack":"~/MMMTools/data/Model/Objects/draining_rack/NloptConverterVicon2MMM_DrainingRackConfig.xml",
                       "plate_dish":"~/MMMTools/data/Model/Objects/plate_dish/NloptConverterVicon2MMM_PlateDishConfig.xml",
                       "sponge_small":"~/MMMTools/data/Model/Objects/sponge_small/NloptConverterVicon2MMM_SpongeSmallConfig.xml",
                       "salad_spoon":"~/MMMTools/data/Model/Objects/salad_spoon/NloptConverterVicon2MMM_SaladSpoonConfig.xml",
                       "cucumber_attachment":"~/MMMTools/data/Model/Objects/cucumber_attachment/NloptConverterVicon2MMM_CucumberCutConfig.xml",
                       "cutting_board_small":"~/MMMTools/data/Model/Objects/cutting_board_small/NloptConverterVicon2MMM_CuttingBoardSmallConfig.xml",
                       "knife_black":"~/MMMTools/data/Model/Objects/knife_black/NloptConverterVicon2MMM_KnifeBlackConfig.xml",
                       "peeler":"~/MMMTools/data/Model/Objects/peeler/NloptConverterVicon2MMM_peeler_config.xml",
                       "cup_large":"~/MMMTools/data/Model/Objects/cup_large/NloptConverterVicon2MMM_CupLargeConfig.xml",
                       "cup_small":"~/MMMTools/data/Model/Objects/cup_small/NloptConverterVicon2MMM_CupSmallConfig.xml",
                       "tablespoon":"~/MMMTools/data/Model/Objects/tablespoon/NloptConverterVicon2MMM_TablespoonConfig.xml"}
for k,v in converterConfigFile.items():
    converterConfigFile[k] = os.path.expanduser(v)

# subject height, mass, and hand_length
outputModelProcessorConfigFile = {"1723":"~/MMMTools/data/Model/Winter/config/1723.xml", "1480":"~/MMMTools/data/Model/Winter/config/1480.xml"}
for k,v in outputModelProcessorConfigFile.items():
    outputModelProcessorConfigFile[k] = os.path.expanduser(v)
