...
# # # # # # # # # # # # # # # # #
# padding for varied size data  #
# # # # # # # # # # # # # # # # #
def pad(data, unpadded_length, padded_length):
    ...
    padded_data = padded_data.to(device=torch.cuda.current_device())
    return padded_data
...
# cosine positional embedder  #
# # # # # # # # # # # # # # # #
def cosine_positional_embedder(unpadded_lengths, padded_length, units, reverse):
    ...
    pe = torch.zeros(size=(padded_length, 1, units))
    ...
    pe = pad(pe, unpadded_lengths, padded_length)    
    return pe